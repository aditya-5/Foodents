...
<head>
  ...
  <title>Godiva Dark Chocolate Cheesecake</title>
  ...
  <main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Godiva Dark Chocolate Cheesecake</h2>
          <ol>
            <li><a href="index.html">Home</a></li>
            <li><a href="search.html">Search Recipes</a></li>
            <li>Godiva Dark Chocolate Cheesecake</li>
          </ol>
        </div>
    ...
    <section id="blog" class="blog">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry entry-single">
              ...
              <div class="entry-img">
                <img src="assets/img/recipeimg/cake.jpg" alt="" class="img-fluid">
              </div>

              <h2 class="entry-title">
                <a href="recipe1.html">Godiva Dark Chocolate Cheesecake</a>
              </h2>
        ...
        <div class="row">
          <div class="col-lg-6">
            <ul class="list-group overview">
              <li><i class="fas fa-clock"></i> <span class="overview-title"> Cooking time:</span> 35 mins</li>
      ...
      <ul class="list-group ingg">
        <li>2½  cup cream cheese, room temperature</li>
        <li>1½ cup sugar</li>
        <li>1½  tablespoon cocoa powder</li>
        <li>5 tablespoon Godiva 85% Dark Chocolate Callets</li>
        <li>2 eggs</li>
        <li>2 egg yolks</li>
        <li>1½  tablespoon crème faiche</li>
